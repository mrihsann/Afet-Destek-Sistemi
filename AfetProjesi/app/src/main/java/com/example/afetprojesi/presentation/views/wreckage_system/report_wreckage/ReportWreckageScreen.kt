package com.example.afetprojesi.presentation.views.wreckage_system.report_wreckage
...
import com.example.afetprojesi.presentation.views.hanger_system.add_to_hanger.PhotoPicker
...
import com.example.afetprojesi.presentation.views.help_system.helpform.LocationInfo
        ...
        bottomBar = {
            SurveyBottomBar(
                ...
                onPreviousPressed = {
                    ...
                    if (currentPageIndex.intValue != 3) {
                ...
                onNextPressed = {
                    ...
                    if ((currentPageIndex.intValue > -1) and (currentPageIndex.intValue < 3)) {
