...
public class HSCKPSPublicSoap
{
    ...
    public HSCKPSPublicSoap(){}

    public HSCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HSCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HSCExtendedSoapSerializationEnvelope envelope= new HSCExtendedSoapSerializationEnvelope(HSCExtendedSoapSerializationEnvelope.VER11);
