...
class HSCSoapFaultEx extends org.ksoap2.SoapFault
{
    public Object fault;
}
...
public class HSCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HSCDateTimeConverter converter)
    {
        if(converter==null)
        {
            converter = new HSCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HSCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HSCDateTimeConverter dateTimeConverter = new HSCStandardDateTimeConverter();

    public HSCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HSCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HSCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HSCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HSCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HSCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
